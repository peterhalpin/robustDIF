---
title: "robustDIF Technical Notes"
author: "Peter F Halpin"
date: last-modified
format:
  html:
    output-file: technical-notes.html
    toc: true
...
Halpin (2022) used the (unstated) assumption that $\Sigma_0$ is diagonal
...
parameters. The overall result is that
...
Halpin (2022) chose $s_i = V_0(Y_i)$ based on a (flawed) argument about
