...
Please see the `README.html` file for a more detailed discussion of the
methodology and recent updates.
...
```
    ...
    ## 
    ## $weights
    ## item1_d1 item2_d1 item3_d1 item4_d1 item5_d1 
    ##   0.0000   0.9979   0.9920   0.9995   0.2536 
    ## 
    ## $rho.value
    ## [1] 1.888
    ## 
...
The estimated scaling parameter is equal to approximately 0.38. We can
see that the first item was downweighted to zero when estimating the
scaling parameter. Note that the standard error of the scaling parameter
is not provided by `rdif` but is available via `delta_test`.
...
```
    ...
    ## item1_d1  0.351130 0.09867  3.55851 0.000373
    ## item2_d1  0.006566 0.06654  0.09868 0.921396
    ## item3_d1  0.017345 0.10888  0.15931 0.873424
    ## item4_d1 -0.006742 0.20492 -0.03290 0.973753
    ## item5_d1 -0.357290 0.24134 -1.48043 0.138757
...
```
    ...
    ## 1    0.3784  0.09674   0.3762 0.09283 0.002202  0.06256 0.03519 0.9719
